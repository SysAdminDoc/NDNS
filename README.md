...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.4.39-7f5af0?style=flat-square" alt="Version">
...
| **Log Enhancements** | Filter by Allowed / Blocked / Cached, hidden domains, and tab-local origin/domain matches. Hide specific domains. Compact mode. Auto-refresh with configurable interval. Real-time log counters. Opt-in offline cache privacy controls with TTL, purge, and export boundaries. |
