...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.4.9-7f5af0?style=flat-square" alt="Version">
...
| **Domain Management** | One-click allow/deny from logs. Bulk allowlist/denylist import. Wildcard/regex builder with recent-log preview. Bulk delete tools with progress tracking. Domain action history. CNAME chain display. |
