...
<p align="center">
  <img src="https://img.shields.io/badge/version-3.4.13-7f5af0?style=flat-square" alt="Version">
...
| **HaGeZi Integration** | One-click sync of TLD blocklists and allowlists from HaGeZi's curated adblock lists, with per-list upstream hashes, counts, and diff views after updates. |
